...
namespace CosmeticsStore.Areas.Admin.Controllers
{
    public class AboutsController : BaseController
    {
        ...
        [ValidateInput(false)]
        public ActionResult Create([Bind(Include = "AboutID,Name,Content,Status")] About about)
        {
        ...
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit([Bind(Include = "AboutID,Name,Content,Status")] About about)
        {
            if (ModelState.IsValid)
            {
