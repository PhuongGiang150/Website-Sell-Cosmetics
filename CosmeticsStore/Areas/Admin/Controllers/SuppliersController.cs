...
namespace CosmeticsStore.Areas.Admin.Controllers
{
    public class SuppliersController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "SupplierID,Name,Address,Email,Phone,Status")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SupplierID,Name,Address,Email,Phone,Status")] Supplier supplier)
        {
            if (ModelState.IsValid)
            {
